...
# mapping
emit() { write_test "$1" "${TESTS_DIR}/$2"; echo "OK ${TESTS_DIR}/$2"; }

emit "00-env.sh"        "t00-env.sh"
emit "00-lib.sh"        "t00-lib.sh"
emit "01-core.sh"       "t01-core.sh"
emit "02-data-plane.sh" "t02-data-plane.sh"
emit "03-app-airbyte.sh" "t03-airbyte.sh"
emit "03-app-n8n.sh"     "t03-n8n.sh"
emit "03-app-zammad.sh"  "t03-zammad.sh"
emit "03-app-dbt.sh"     "t03-dbt.sh"
emit "04-portal-api.sh"  "t04-portal-api.sh"
emit "04-portal-ui.sh"   "t04-portal-ui.sh"
emit "05-validate.sh"    "t05-validate.sh"
